...
for i in data_info['products']:
    ...
    rating = str(i['rating'])
    stock = str(i['stock'])
    sql = 'INSERT INTO `product`(`title`, `discription`, `price`, `discount`, `rating`, `stock`, `brand`, `category`) VALUES ("'+i['title']+'","'+i['description']+'", "'+price+'","'+discout+'","'+rating+'","'+stock+'","'+i['brand']+'","'+i['category']+'")'
